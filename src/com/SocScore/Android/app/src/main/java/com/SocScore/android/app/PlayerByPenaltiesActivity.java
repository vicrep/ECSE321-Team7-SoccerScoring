...
public class PlayerByPenaltiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_by_penalties);
        setUpVariables();
        PlayerAdapter playerAdapter = new PlayerAdapter(players, PlayerByPenaltiesActivity.this);
    ...
    {
        playerAnalysis.applyRank(PlayerRankType.PENALTY);
        players = playerAnalysis.getPlayers();
        list_view_players = (ListView) findViewById(R.id.list_view_players_penalties);
    }

    public void closePlayerAnalysisPenalties(View view)
    {
