...
public class PlayerByYellowCardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_by_yellow_cards);
        setUpVariables();
        PlayerAdapter playerAdapter = new PlayerAdapter(players , PlayerByYellowCardsActivity.this);
        list_view_players.setAdapter(playerAdapter);
    }

    public void closePlayerAnalysisYellow(View view)
    {
    ...
    {
        playerAnalysis.applyRank(PlayerRankType.YELLOWCARDS);
        players = playerAnalysis.getPlayers();
        list_view_players = (ListView) findViewById(R.id.list_view_players_yellow);
    }
