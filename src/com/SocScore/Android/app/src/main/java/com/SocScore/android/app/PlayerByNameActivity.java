...
public class PlayerByNameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_by_name);
        setUpVariables();
        PlayerAdapter playerAdapter = new PlayerAdapter(players , PlayerByNameActivity.this);
        list_view_players.setAdapter(playerAdapter);
    }

    public void setUpVariables()
    {
        playerAnalysis.applyRank(PlayerRankType.NAME);
        players = playerAnalysis.getPlayers();
        list_view_players = (ListView) findViewById(R.id.list_view_players_name);
    }

    public void closePlayerAnalysisName(View view)
    {
