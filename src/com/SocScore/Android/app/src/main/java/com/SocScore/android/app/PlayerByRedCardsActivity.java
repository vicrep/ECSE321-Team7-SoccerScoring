...
public class PlayerByRedCardsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_by_red_cards);
        setUpVariables();
        PlayerAdapter playerAdapter = new PlayerAdapter(players , PlayerByRedCardsActivity.this);
        list_view_players.setAdapter(playerAdapter);
    }

    public void setUpVariables()
    {
        playerAnalysis.applyRank(PlayerRankType.REDCARDS);
        players = playerAnalysis.getPlayers();
        list_view_players = (ListView) findViewById(R.id.list_view_players_red);
    }

    public void closePlayerAnalysisRed(View view)
    {
