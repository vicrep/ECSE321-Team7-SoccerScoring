...
public class PlayerByGoalsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_by_goals);
        setUpVariables();
        PlayerAdapter playerAdapter = new PlayerAdapter(players , PlayerByGoalsActivity.this);
        list_view_players.setAdapter(playerAdapter);
    }

    public void setUpVariables()
    {
        playerAnalysis.applyRank(PlayerRankType.GOALS);
        players = playerAnalysis.getPlayers();
        list_view_players = (ListView) findViewById(R.id.list_view_players_goals);
    }

    public void closePlayerAnalysisGoals(View view)
    {
